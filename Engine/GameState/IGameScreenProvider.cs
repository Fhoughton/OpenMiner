...
// Type: StudioForge.Engine.GameState.IGameScreenProvider
...
{
  public interface IGameScreenProvider
  {
    GameScreen GetNewBackgroundScreen();

    GameScreen GetNewMainMenuScreen();
  }
}
