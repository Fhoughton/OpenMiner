...
// Type: StudioForge.Engine.Core.Vec2Interpolator
...
namespace StudioForge.Engine.Core
{
  public class Vec2Interpolator : Interpolator<Vector2>
  {
    ...
    {
      if (!this.smoothStep)
        return Vector2.Lerp(this.value1, this.value2, (float) (this.currentDuration / this.totalDuration));
      return Vector2.SmoothStep(this.value1, this.value2, (float) (this.currentDuration / this.totalDuration));
    }
  }
}
