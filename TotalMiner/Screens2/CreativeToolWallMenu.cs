...
// Type: StudioForge.TotalMiner.Screens2.CreativeToolWallMenu
...
{
  internal class CreativeToolWallMenu : CreativeToolMenu
  {
    ...
    protected override string SelectBlockText
    {
      get
      {
        return "Select a Block for the Wall";
      }
    }
    ...
    public CreativeToolWallMenu(
      PauseMenuScreen2 parentScreen,
      GameInstance instance,
      Player player,
      Action onApplied)
      : base(parentScreen, instance, player, instance.CreativeModeHelper.GetWallCommandData(player), onApplied)
    {
    }
