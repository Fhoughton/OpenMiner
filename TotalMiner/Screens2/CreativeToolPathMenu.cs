...
// Type: StudioForge.TotalMiner.Screens2.CreativeToolPathMenu
...
{
  internal class CreativeToolPathMenu : CreativeToolMenu
  {
    ...
    protected override string SelectBlockText
    {
      get
      {
        return "Select a Block for the Path";
      }
    }
    ...
    public CreativeToolPathMenu(
      PauseMenuScreen2 parentScreen,
      GameInstance instance,
      Player player,
      Action onApplied)
      : base(parentScreen, instance, player, instance.CreativeModeHelper.GetPathCommandData(player), onApplied)
    {
    }
      ...
      float scale)
    {
      ...
      ((ITextInputWindow) dataField).OnValidateInput = new Action<ITextInputWindow>(this.ValidateWidth);
    ...
    {
      this.player.SetCreativePathDefaults(this.data);
    }
