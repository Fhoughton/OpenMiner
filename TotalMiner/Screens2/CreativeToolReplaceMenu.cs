...
// Type: StudioForge.TotalMiner.Screens2.CreativeToolReplaceMenu
...
{
  internal class CreativeToolReplaceMenu : CreativeToolMenu
  {
    ...
    private string BlockID1Text
    {
      get
      {
        Item blockId1 = (Item) this.data.BlockID1;
        if (blockId1 == Item.None)
          return "None";
        return ItemData2.ForDisplay(this.instance, blockId1);
      }
    }
    ...
    public CreativeToolReplaceMenu(
      PauseMenuScreen2 parentScreen,
      GameInstance instance,
      Player player,
      Action onApplied)
      : base(parentScreen, instance, player, instance.CreativeModeHelper.GetReplaceCommandData(player), onApplied)
    {
    }
