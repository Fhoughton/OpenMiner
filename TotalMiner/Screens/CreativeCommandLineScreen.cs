...
// Type: StudioForge.TotalMiner.Screens.CreativeCommandLineScreen
...
{
  internal class CreativeCommandLineScreen : CreativeCommandScreen
  {
    protected override string SelectBlockText
    {
      get
      {
        return "Select Block for the Line";
      }
    }
    ...
    public CreativeCommandLineScreen(GameInstance instance, Player player)
      : base(instance, player, instance.CreativeModeHelper.GetLineCommandData(player))
    {
    }
