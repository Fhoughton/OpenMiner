...
// Type: StudioForge.TotalMiner.AI.ComparisonNodeShort
...
{
  public abstract class ComparisonNodeShort : ComparisonNode<short>
  {
    protected ComparisonNodeShort()
    {
    }

    protected ComparisonNodeShort(INPCBehaviour npc)
      : base(npc)
    {
    }

    protected override bool Compare(short actual, short value)
    {
