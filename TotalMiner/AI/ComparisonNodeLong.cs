...
// Type: StudioForge.TotalMiner.AI.ComparisonNodeLong
...
{
  public abstract class ComparisonNodeLong : ComparisonNode<long>
  {
    protected ComparisonNodeLong()
    {
    }

    protected ComparisonNodeLong(INPCBehaviour npc)
      : base(npc)
    {
    }

    protected override bool Compare(long actual, long value)
    {
