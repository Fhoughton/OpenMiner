...
// Type: StudioForge.TotalMiner.AI.ComparisonNodeByte
...
{
  public abstract class ComparisonNodeByte : ComparisonNode<byte>
  {
    protected ComparisonNodeByte()
    {
    }

    protected ComparisonNodeByte(INPCBehaviour npc)
      : base(npc)
    {
    }

    protected override bool Compare(byte actual, byte value)
    {
